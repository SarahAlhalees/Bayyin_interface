...
# -----------------------------------------
st.set_page_config(
    page_title="بَيِّنْ — مصنف سهولة القراءة",
    page_icon="📘",
    layout="centered"
)
...
# UI Layout
# -----------------------------------------
st.title("📘 بَيِّنْ — مصنف سهولة القراءة للنصوص العربية")
st.markdown("""
### ✨ أدخل النص ليتم تحديد مستوى سهولة قراءته  
يعتمد النموذج على AraBERTv2 + D3Tok لمعالجة النصوص العربية وتحليل مستوى الصعوبة.
""")
